...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_All
    {
        ...
        {
            var doAll = PracticeData[0].Students.All(c => c.FirstName.Contains("e")); 
            Assert.IsTrue(doAll); //<-- change false to doAll
        }
        ...
        {
            var doAll = PracticeData.Where(c => c.Active ==true).All(c => c.PrimaryInstructor.FirstName.Contains("e"));
            Assert.IsTrue(doAll); //<-- change false to doAll
        }
    }
}
